            ...
            <div class="card-body">
                <form @submit="uploadPresentation">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <select class="form-control" id="ttype" v-model="form.user">
    ...
    export default {
        ...
        methods:{
            ...
            uploadPresentation(e)
            {
                ...
                axios.post('api/presentation',formData, config)
                    .then(response=>{
                        this.form.reset();
                        this.filename='';
            ...
            getResults(page)
            {
                ...
                axios.get('api/presentation?page='+page)
            ...
            updateRecord(e)
            {
                ...
                axios.post('api/presentation/'+this.updateId,formData, config)
                    .then(response=>{
                        this.form.reset();
                        this.filename='';
