                ...
                <form @submit="uploadAssignment">
                    ...
                    <div class="form-group form-check-inline d-flex flex-row justify-content-around">
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" value="document" id="document" v-model="form.filetype" name="customRadio">
                            <label for="document" class="custom-control-label">Document</label>
                        </div>
                        <div class="custom-control custom-radio">
                            ...
                            <tr  class="text-center" v-for="(records,index) in records.data">
                                ...
                                <td>
                                    <div class="d-flex flex-row justify-content-center">
                                        <a @click="editPresentation(records.assignment_id)">
                                            <i class="fas fa-lg fa-pen text-info">
                                            </i>
                                        </a>
                                        <a class="pl-3" @click="delRec(records.assignment_id)">
    ...
    export default {
        ...
        methods:{
            ...
            uploadAssignment(e)
            {
                ...
                axios.post('api/assignment',formData, config)
                    .then(response=>{
                        this.form.reset();
                        this.filename='';
            ...
            getCourseData()
            {
                axios.get('api/addcourse/assignment')
            ...
            getResults(page)
            {
                ...
                axios.get('api/assignment?page='+page)
            ...
            updateRecord(e)
            {
                ...
                axios.post('api/assignment/'+this.updateId,formData, config)
                    .then(response=>{
                        this.form.reset();
                        this.filename='';
            ...
            deleteRecord() {
                axios.delete('api/assignment/'+this.currentId)
                    .then(response=>{
